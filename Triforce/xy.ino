//explorer with an exteneded tail
//goes exploring
int del = 20;
int hue = 64;
int sat = 0;
...
switch (md){
 ...
 case 2:  { WRU (); if (WBRx == 1) {WBRtail(); WBRx = 0; } if (CLDx == 1) {CLDtail(); CLDx = 0; } if (CBLx == 1) {CBLtail(); CBLx = 0; } randNo = random(3); if (randNo == 0) { md = 6;} if (randNo == 1) { md = 8;} if (randNo == 2) { md = 5;} break; } //WRU
