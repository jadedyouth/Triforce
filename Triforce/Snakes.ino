...
LEDS.show();
  ...
  leds[Power[num]] = CHSV(hue, sat, 255);
   leds[Wisdom[num1]] = CHSV(hue, sat, 255); 
    leds[Courage[num2]] = CHSV(hue, sat, 255);
    delay(10);
...
LEDS.show();
  ...
  leds[Power[num]] = CHSV(hue, sat, 0);
   leds[Wisdom[num1]] = CHSV(hue, sat, 0); 
    leds[Courage[num2]] = CHSV(hue, sat, 0);
    delay(10);
...
for(int i = 0; i < 99; i++) {
    ...
    leds[Power[i+1]] = CHSV(hue, 0, 255);
   
    FastLED.show(); 
    
    leds[Power[i]] = CHSV(hue, sat, 255);
    delay(10);
  }  
...
for(int i = 0; i < 99; i++) {
    ...
    leds[Wisdom[i+1]] = CHSV(hue, 0, 255);
   
    FastLED.show(); 
    
    leds[Wisdom[i]] = CHSV(hue, sat, 255);
    delay(10);
  } 
...
for(int i = 0; i < 99; i++) {
    ...
    leds[Courage[i+1]] = CHSV(hue, 0, 255);
   
    FastLED.show(); 
    
    leds[Courage[i]] = CHSV(hue, sat, 255);
    delay(10);
  }  
